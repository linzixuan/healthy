...
public class FavorMedicalListApapter extends BaseAdapter {
	private Context context;
	private LayoutInflater inflater;
	private List<MedicalCase> datas;

	public FavorMedicalListApapter(Context context,List datas){
	...
	public View getView(int index, View view, ViewGroup parent) {
		...
		if(view==null){
			...
			view = inflater.inflate(R.layout.favormedicallist_item, null);
