...
public class AdviceInputActivity extends CommonActivity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_adviceinput);
		initUI();
		initDatas();
	}
	...
	private void initDatas(){
        ...
        String fdAdvice=bundle.getString("fdAdvice");
        fdContent.setText(fdAdvice);
	...
	public boolean onTouch(View view, MotionEvent event) {
		...
		case R.id.btnSave:
			...
			case MotionEvent.ACTION_UP:
				...
				String advice=fdContent.getText().toString();
		...
		case R.id.btnSelect:
			...
			case MotionEvent.ACTION_UP:
				...
				Intent it=new Intent(this, AdviceSelectActivity.class);
				Bundle bundle=new Bundle();
		...
		if (requestCode == 0) {
			try {
				...
				if(null!=bundle){
					...
					fdContent.getText().insert(index, bundle.getString("advice"));
				}
			} catch (Exception e) {
				e.printStackTrace();
			}
